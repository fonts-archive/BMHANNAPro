...
사용하는 `font-family`의 이름은 `BM HANNA Pro`입니다.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/BMHANNAPro/subsets/BMHANNAPro-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/BMHANNAPro/subsets/BMHANNAPro-dynamic-subset.css');
```
...
```css
font-family: "BM HANNA Pro", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
